...
public class CommandManager {
    ...
    public <T> CompletableFuture<T> submitCustomCommand(
        ...
        if (isBlockingCustomCommand(arguments)) {
            return submitDirectBlockingCommand(RequestType.CustomCommand, args, null, true, responseHandler);
        }
    ...
    public <T> CompletableFuture<T> submitCustomCommand(
        ...
        if (isBlockingCustomCommand(arguments)) {
            return submitDirectBlockingCommand(RequestType.CustomCommand, args, null, false, responseHandler);
        }
    ...
    public <T> CompletableFuture<T> submitCustomCommand(
        ...
        byte[][] args = stringsToBytes(arguments);
        if (isBlockingCustomCommand(arguments)) {
            return submitDirectBlockingCommand(RequestType.CustomCommand, args, route, true, responseHandler);
        }
    ...
    public <T> CompletableFuture<T> submitCustomCommand(
        ...
        byte[][] args = glideStringsToBytes(arguments);
        if (isBlockingCustomCommand(arguments)) {
            return submitDirectBlockingCommand(RequestType.CustomCommand, args, route, false, responseHandler);
        }
    ...
    public <T> CompletableFuture<T> submitNewBatch(
        ...
        return submitBatchDirect(
                batch, raiseOnError, timeout, retryServerError, retryConnectionError, route,
                expectUtf8Response, responseHandler);
    }
    ...
    private LinkedHashMap<Object, Object> deserializeByteBufferMap(
        ...
        LinkedHashMap<Object, Object> map =
                new LinkedHashMap<>(Math.min(count, 1024));

...
public class GlideNativeBridge {
    ...
    /**
     * Execute command asynchronously. Passes command parameters
     * directly via JNI to avoid serialize/deserialize overhead.
     */
    ...
    /**
     * Execute batch asynchronously. Passes batch commands directly
     * via JNI arrays.
     *

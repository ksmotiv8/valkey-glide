...
public class GlideCoreClient implements AutoCloseable {
    ...
    /**
     * Execute command asynchronously. Passes requestType, args, and
     * routing directly via JNI.
     */
    public CompletableFuture<Object> executeCommandDirect(
        ...
        try {
            ...
            try {
                correlationId =
                        AsyncRegistry.register(future, this.maxInflightRequests, handle, timeoutMs);
            } catch (glide.api.models.exceptions.RequestException e) {
                future.completeExceptionally(e);
                return future;
            }
